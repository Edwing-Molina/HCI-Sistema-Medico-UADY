# Software Quality and Usability Evaluation - Ceidi Paloma Beltran Torres
...
- **Recovery:** 0 (Did not require correcting the email format).
...
- **Task Completion:** Yes, she precisely selected the target parameters (Specialty, Shift, Date, Doctor, and Time slots) and booked the appointment without any physical difficulty.
...
- **Completion:** Completed successfully. This user had no registered family dependents active on her profile record. Thus, she executed the test cancellations directly upon her own primary account flow, concluding the evaluation smoothly.
...
| :--------------- | :--------------------------------------------------------- | :-----------------: | :--------: | :-----------: | :-------------------: |
| **Login**        | **Task 1:** Log in with credentials                        |         Yes         |     6      |       0       |           1           |
| **Login**        | **Task 2:** Restart the application (Validate persistence) |         Yes         |     2      |       0       |           0           |
| **Appointments** | **Task 1:** Book primary medical appointment               |         Yes         |     9      |       1       |           0           |
| **Appointments** | **Task 2:** Verification of appointment success in list    |         Yes         |      1    |       0       |           1           |
| **Appointments** | **Task 3:** Visualization of basic data on card summary    |         Yes         |     7      |       1       |           1           |
